...
const basePreorderProducts: PreorderProduct[] = [
  ...
  },
  {
    id: "preorder-a-hero",
    title: "A. Hero",
    slug: "a-hero-11x14-print",
    artworkSlug: "a-hero",
    showOnPreorderPage: true,
    type: "print",
    price: 35,
    image: "/art/collage/a-hero-web.jpg",
    imageAlt: "A. Hero collage.",
    size: "11x14 signed print",
    badge: "Pre-Order",
    description: "Archival quality signed print from the launch preorder batch.",
    includes: ["Signed 11x14 print", "Archival quality print", "Free random 5x7 cardstock print included"],
    ...
    preorderBonusEligible: true,
    preorderButtonLabel: "Pre-Order Now",
    snipcartName: "Pre-Order: A. Hero 11x14 Signed Print",
    snipcartDescription:
      "Archival quality signed preorder print. Estimated shipping: Late June 2026. Includes a free random 5x7 cardstock print.",
  },
  {
    id: "preorder-a-hero-8x10",
    title: "A. Hero",
    slug: "a-hero-8x10-print",
    artworkSlug: "a-hero",
    showOnPreorderPage: true,
    type: "print",
    price: 25,
    ...
    preorderBonusEligible: true,
    preorderButtonLabel: "Pre-Order Now",
    snipcartName: "Pre-Order: A. Hero 8x10 Signed Print",
    snipcartDescription:
      "Archival quality signed preorder print. Estimated shipping: Late June 2026. Includes a free random 5x7 cardstock print.",
  },
];
